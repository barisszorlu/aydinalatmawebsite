...
(function () {
  ...
  Donald.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
    navigator.userAgent
  ); // Detect Mobile
  Donald.defaults = {
    animation: {
    ...
    if ($.fn.themePluginParallax) {
      Donald.$(selector).each(function () {
        ...
        $this.themePluginParallax(
          $.extend(
            true,
            Donald.parseOptions($this.attr("data-parallax-options")),
            options
          )
        );
      });
  ...
  Donald.stickyHeader = function (selector) {
    ...
    var stickyHeaderWrap = function () {
      ...
      if (
        !isWrapped &&
        window.innerWidth >= Donald.defaults.stickyHeader.activeScreenWidth
      ) {
        isWrapped = true;
        $stickyHeader.wrap(
      ...
      $stickyContents.each(function (index) {
        ...
        if (
          ...
          if (options.scrollMode) {
            ...
            if ($item.hasClass("app-sticky-header")) {
              $item[0].dispatchEvent(
                new CustomEvent("headerload", {
                  detail: {},
                })
              );
            }
      ...
      Donald.appear(el, function () {
        if (el.classList.contains("appear-animate")) {
          var settings = $.extend(
            ...
            Donald.parseOptions(el.getAttribute("data-animation-options"))
          );
  ...
  Donald.stickySidebar = function (selector) {
    if ($.fn.themeSticky) {
      Donald.$(selector).each(function () {
        ...
        $this.themeSticky(
          $.extend(
            Donald.defaults.stickySidebar,
            Donald.parseOptions($this.attr("data-sticky-options"))
          )
        );
  ...
  Donald.popup = function (options, preset) {
    var mpInstance = $.magnificPopup.instance,
      opt = $.extend(
        ...
        "undefined" != typeof preset
          ? Donald.defaults.popupPresets[preset]
          : {},
        options
      );
    ...
    if (
      mpInstance.isOpen &&
      mpInstance.content &&
      !mpInstance.content.hasClass("login-popup")
    ) {
  ...
  Donald.initPurchasedMinipopup = function () {
    if (
      Donald.byClass("product-single").length ||
      Donald.byClass("main-content").length
    ) {
  ...
  Donald.sidebar = (function () {
    ...
    Sidebar.prototype.toggle = function () {
      ...
      // if fixed sidebar
      if (
        window.innerWidth >= Donald.minDesktopWidth &&
        self.$sidebar.hasClass("sidebar-fixed")
      ) {
        // is closed ?
        ...
        // activate sidebar
        Donald.$body.toggleClass(self.name + "-active").removeClass("closed");

        // issue
        if (
          window.innerWidth >= 1200 &&
          Donald.$body.hasClass("with-flex-container")
        ) {
  ...
  Donald.initProductSingle = (function () {
    ...
    var thumbsInit = function (self) {
      ...
      self.thumbsIsVertical =
        self._isPgvertical && window.innerWidth >= Donald.minDesktopWidth;
    ...
    var initCartAction = function (self) {
      ...
      self.$wrapper.on("click", ".btn-cart", function (e) {
        ...
        if (
          ...
          Donald.Minipopup.open({
            message:
              'Successfully added.<a href="cart.html" class="btn btn-link btn-sm btn-slide-right btn-infinite">View Cart<i class="d-icon-arrow-right"></i></a>',
  ...
  Donald.slider = (function () {
    ...
    var onSliderInitialized = function (e) {
      ...
      $el.find(".owl-item.active .slide-animate").each(function () {
        ...
        var temp = Donald.requestTimeout(
          function () {
    ...
    Donald.defaults.sliderPresets[
      "product-single-carousel"
    ].onInitialized = Donald.defaults.sliderPresets[
      "product-gallery-carousel"
    ].onInitialized = Slider.zoomImage;
    Donald.defaults.sliderPresets[
      "product-single-carousel"
    ].onRefreshed = Donald.defaults.sliderPresets[
      "product-gallery-carousel"
    ...
    Slider.prototype.init = function ($el, options) {
      ...
      $.extend(
        true,
        settings,
        Donald.parseOptions($el.attr("data-owl-options")),
        options
      );
  ...
  Donald.Menu = {
    ...
    initFilterMenu: function () {
      ...
      //   e.preventDefault();
      // });
      $(".app-custom.app-link.app-sidebar-link").on("click", function (e) {
  ...
  Donald.floatSVG = (function () {
    ...
    FloatSVG.prototype.update = function () {
      ...
      if (this.$el.length && Donald.isOnScreen(this.$el[0])) {
  ...
  Donald.Shop = {
    ...
    initProductsCartAction: function () {
      ...
      Donald.$body.on(
        "click",
        ".btn-product-icon.btn-cart, .btn-product.btn-cart",
        function (e) {
          e.preventDefault();
  ...
  function handleProductGalleryNowClick() {
    $(document).ready(function () {
      $('#appProductCarouselNavContainer').click(function () {
        let appProductCarouselVideo = $('#appProductCarouselVideo');
        appProductCarouselVideo[0].contentWindow.postMessage('{"event":"command","func":"stopVideo","args":""}', '*')
      });
    });
  }
